...
// FIXED: Correct field mappings for restaurant and location
...
export default function StoreModal({
  ...
  useEffect(() => {
    if (mode === "edit" && store) {
      form.setFieldsValue({
        restaurantId: store.restaurant.restaurantId, // FIXED: get from nested object
        locationId: store.location.locationId, // FIXED: get from nested object
